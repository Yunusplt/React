...
export default function KpiCards() {
  ...
  return (
    <Grid numItemsSm={2} numItemsLg={3} className="gap-6  w-11/12 mx-auto">
      {categories.map((item) => (
        <Card className="min-w-[202px]" key={item.title} decoration="top" decorationColor={item.color}>
          <Flex justifyContent="start" className="space-x-4">
            ...
            <div className="">
              ...
              <Metric className="sm:text-base md:text-lg">{item.metric}</Metric>
            </div>
          </Flex>
        </Card>
      ))}
...
//! Diğer versiyon muili KpiCard canlidan örnek 
